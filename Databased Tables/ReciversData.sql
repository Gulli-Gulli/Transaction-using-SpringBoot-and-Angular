CREATE TABLE IF NOT EXISTS ReciversData (
    `BIC` VARCHAR(11) CHARACTER SET utf8,
    `Rec_Institution_Name` VARCHAR(54) CHARACTER SET utf8
);
INSERT INTO ReciversData VALUES
